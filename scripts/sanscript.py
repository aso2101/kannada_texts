...
def _setup():
  ...
  SCHEMES.update({
    ...
    GUJARATI: Scheme({
      'vowels': s("""અ આ ઇ ઈ ઉ ઊ ઋ ૠ ઌ ૡ ઍ એ ઐ ઑ ઓ ઔ"""),
      'marks': s("""ા િ ી ુ ૂ ૃ ૄ ૢ ૣ ૅ ે ૈ ૉ ો ૌ"""),
      'virama': s('્'),
      'other': s('ં ઃ ઁ'),
      'consonants': s("""
                            ક ખ ગ ઘ ઙ
    ...
    IAST: Scheme({
      'vowels': s("""a ā i ī u ū ṛ ṝ ḷ ḹ ĕ e ai ŏ o au"""),
      'marks': s("""ā i ī u ū ṛ ṝ ḷ ḹ ĕ e ai ŏ o au"""),
      'virama': [''],
      'other': s('ṃ ḥ m̐'),
      'consonants': s("""
                            k kh g gh ṅ
    ...
    ISO: Scheme({
      'vowels': s("""a ā i ī u ū r̥ r̥̄ l̥ l̥̄ e ē ai o ō au"""),
      'marks': s("""ā i ī u ū r̥ r̥̄ l̥ l̥̄ e ē ai o ō au"""),
      'virama': [''],
      'other': s('ṁ ḥ m̐'),
      'consonants': s("""
                            k kh g gh ṅ
    ...
    SLP1: Scheme({
      'vowels': s("""a A i I u U f F x X Z e E F o O"""),
      'marks': s("""A i I u U f F x X Z e E F o O"""),
      'virama': [''],
      'other': s('M H ~'),
      'consonants': s("""
                            k K g G N
